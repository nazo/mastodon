const ja = {
  ...
  "compose_form.privacy_disclaimer": "あなたの非公開ナゾるは返信先のユーザー（at {domains}）に公開されます。{domainsCount, plural, one {that server} other {those servers}}を信頼しますか？投稿のプライバシー保護はMastodonサーバー内でのみ有効です。 もし{domains} {domainsCount, plural, one {is not a Mastodon instance} other {are not Mastodon instances}}ならばあなたの投稿のプライバシーは保護されず、ごちなぞるされたり予期しないユーザーに見られる可能性があります。",
  "compose_form.publish": "ナゾる",
  ...
  "home.column_settings.show_reblogs": "ごちなぞる表示",
  ...
  "notification.favourite": "{name} さんがあなたのナゾるをお気に入りに登録しました",
  "notification.follow": "{name} さんにフォローされました",
  "notification.mention": "{name} さんがあなたに返信しました",
  "notification.reblog": "{name} さんがあなたのナゾるをごちなぞるしました",
  ...
  "notifications.column_settings.reblog": "ごちなぞる",
  "notifications.column_settings.show": "カラムに表示",
  "notifications.column_settings.sound": "通知音を再生",
  "notifications.settings": "カラム設定",
  "onboarding.next": "次へ",
  "onboarding.page_one.welcome": "Nazodonへようこそ！",
  "onboarding.page_one.federation": "Nazodonは誰でも参加できるSNSです。",
  ...
  "status.open": "詳細を表示",
  "status.reblog": "ごちなぞる",
  "status.reblogged_by": "{name} さんにごちなぞるされました",
  "status.reply": "返信",
